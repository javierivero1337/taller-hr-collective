...
### El Estado Actual del Desempeño
...
### Sesgos en la Evaluación (Los "Vampiros" del Desempeño)
...
### El Cambio de Paradigma: De Opiniones a Evidencias
...
### ¿Qué es una Competencia? (El ADN del Talento)
*   **Definición:** Una competencia no es solo "saber hacer algo" (habilidad), es la intersección de **Conocimiento, Habilidad y Actitud** que se traduce en un comportamiento observable. Es el "cómo" se logran los resultados.
*   **Ejemplos de Leading Companies:**
    *   **Netflix:** "Context, not Control" (Contexto, no Control), "Highly Aligned, Loosely Coupled".
    *   **Uber:** "Go Get It" (Ve por ello), "Build with Heart" (Construye con Corazón).
    *   **Stripe:** "Users First" (Usuarios Primero), "Move with Urgency" (Muévete con Urgencia), "Operational Excellence".
*   **La Estructura de una Competencia (El BAR):**
    Cada competencia tiene una "barra" (BAR) que define el estándar de desempeño. No es binario (lo tienes o no), es un espectro de comportamiento observable.
*   **Ejemplo Deep Dive: "Operational Excellence" (Stripe)**
    *   *Definición Simple:* Mantener un alto estándar de calidad y fiabilidad en todo lo que hacemos.
    *   *Los 3 Niveles del BAR (Observable Behaviors):*
        *   **Barra Baja (Needs Improvement):** "Entrega trabajo con errores frecuentes; requiere supervisión constante; ignora los procesos establecidos."
        *   **Barra Media (Meets Expectations):** "Entrega trabajo consistente y libre de errores; sigue los playbooks operativos; soluciona problemas cuando aparecen."
        *   **Barra Alta (Bar Raiser):** "Mejora sistemáticamente los procesos para prevenir errores futuros; establece nuevos estándares de calidad para el equipo; automatiza tareas manuales."
*   **Conexión:** Aquí es donde entra **BARS**. Para evitar que "Excelencia" sea una opinión subjetiva, usamos BARS para anclar esos niveles en descripciones conductuales específicas.
...
### De Adjetivos a Comportamientos (BARS en Acción)
*   **Caso: Competencia "Resolución de Problemas"**
*   **Escala Tradicional (Mala)**:
    *   1: Insatisfactorio | 2: Cumple | 3: Excelente.
*   **Escala BARS (Buena)**:
    ...
    *   **Nivel 2 (Cumple):** "Identifica cuellos de botella antes de que escalen y propone soluciones viables basadas en datos."
    *   **Nivel 3 (Excede):** "Anticipa fallos sistémicos meses antes y rediseña los procesos para prevenir problemas en otras áreas."

### La Anatomía de una Competencia Aumentada
1.  **Nombre**: Etiqueta clara (ej. Operational Excellence).
2.  **Definición**: Qué significa esto específicamente para nuestra cultura (ej. "Mantener un alto estándar de calidad y fiabilidad").
3.  **Dimensiones**: Sub-habilidades que la componen (ej. Calidad de Entrega, Mejora de Procesos, Automatización).
4.  **Rúbrica BARS (El BAR)**: Los niveles de dominio (Barra Baja, Media, Alta) con ejemplos de comportamientos observables que "suben la vara".
5.  **Evidencias**: Hechos concretos que demuestran en qué peldaño de la escalera se encuentra el colaborador.

### El Competency Scorecard (La Brújula del Talento)
*   **Visualización**: Una tabla que consolida el perfil conductual de un colaborador.

| Competencia | Definición (Cultura) | Nivel Actual (BAR) | Comportamiento Observable (Evidencia) |
| :--- | :--- | :--- | :--- |
| **Operational Excellence** | Calidad y fiabilidad en la ejecución. | **Barra Alta** | Rediseñó el flujo de despliegue eliminando 2 pasos manuales y reduciendo errores en un 15%. |
| **Ownership** | Responsabilidad radical por los resultados. | **Barra Media** | Tomó la iniciativa de liderar la migración de base de datos sin que se le solicitara explícitamente. |
| **Users First** | Empatía y foco en el valor al cliente. | **Barra Media** | Resolvió 3 tickets críticos de clientes sugiriendo una mejora en la UI que evitó futuros reportes. |
| **Move with Urgency** | Velocidad de aprendizaje y ejecución. | **Barra Baja** | Sus entregas suelen retrasarse por exceso de perfeccionismo en tareas no críticas. |
| **Collaborate Egolessly** | Trabajo en equipo sin fricciones de ego. | **Barra Alta** | Mentorizó a 2 juniors durante el trimestre, priorizando el éxito de ellos sobre su visibilidad personal. |

### ¿Por qué este sistema es superior?
1.  **Elimina la "Inflación de Notas"**: Ya no es un "te pongo un 4 porque me caes bien". Es un "estás en este nivel porque *hiciste* esto".
