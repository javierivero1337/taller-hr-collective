# Sesión 3: The AI-Augmented Interview

## Bloque 1: Apertura (15 min)

### El Proceso de Hiring: El Embudo de Decisión
...
### Sesgos Cognitivos: Los Enemigos del Talento
...
### La Falacia de la Entrevista No Estructurada
...
### El Scorecard y las Evidencias Conductuales
*   *Concepto:* No se puede medir lo que no se define. Un Scorecard es una herramienta para objetivizar la observación.
*   *¿Qué es una Evidencia Conductual?*: Es un hecho observable y verificable que demuestra una competencia. No es una opinión ("Me pareció proactivo"), sino una acción ("El candidato describió cómo diseñó un nuevo flujo de aprobación que redujo el tiempo de espera en un 20%").
*   **La Rúbrica de Evidencias**:
    *   **Mala (Subjetiva):** "Puntúa del 1 al 5 qué tan bueno es comunicando". (Depende del humor del entrevistador).
    *   **Buena (Conductual):** "Busca evidencia de: Uso de lenguaje claro, capacidad de síntesis en temas complejos, escucha activa sin interrupciones".
*   **Visualización de Evidencias (Ejemplos)**:
    | Competencia | Evidencia Débil (Opinión) | Evidencia Fuerte (Hecho) |
    | :--- | :--- | :--- |
    | **Liderazgo** | "Se ve que sabe mandar." | "Explicó cómo gestionó un conflicto entre dos reportes directos usando mediación." |
    | **Resiliencia** | "Es una persona muy aguantadora." | "Narró cómo mantuvo la operación tras perder al 30% del equipo en una semana." |
    | **Foco en Usuario** | "Le importa mucho el cliente." | "Citó 3 cambios en el producto que impulsó tras leer tickets de soporte." |

### El Método STAR: La Estructura de la Verdad
Para extraer evidencias fuertes, la entrevista debe forzar al candidato a estructurar su respuesta:
1.  **S**ituación: Contexto de lo que pasó.
2.  **T**area: Cuál era su responsabilidad.
3.  **A**cción: Qué hizo específicamente (el "Yo", no el "Nosotros").
4.  **R**esultado: Qué pasó al final (con datos si es posible).

**Ejemplo de una respuesta STAR perfecta:**
*   **Pregunta:** "Cuéntame de alguna vez que tuviste que manejar un pico de trabajo inesperado."
*   **Respuesta:**
    *   *(Situación)*: "En el Black Friday pasado, nuestro sistema de pagos falló y se acumularon 500 tickets de soporte en 2 horas."
    *   *(Tarea)*: "Mi rol era coordinar al equipo de atención al cliente para que la frustración de los usuarios no escalara a redes sociales."
    *   * (Acción)*: "Diseñé una respuesta rápida con un cupón de descuento automático, segmenté al equipo en 'casos críticos' y 'dudas generales', y yo personalmente manejé a los 10 clientes con mayor volumen de compra."
    *   *(Resultado)*: "Logramos responder al 100% de los afectados en menos de 4 horas y la tasa de cancelación de pedidos fue de solo el 2%, comparado con el 15% del año anterior."

### El Rol de la IA en el Análisis de Evidencias
La IA no reemplaza al reclutador, sino que actúa como un **Auditor de Objetividad**:
*   **Detección de Patrones:** Encuentra contradicciones entre diferentes partes de la entrevista.
*   **Eliminación de Ruido:** Filtra las "muletillas" y el lenguaje decorativo para centrarse en los verbos de acción.
*   **Extracción de Citas:** Provee la "prueba reina" (citas textuales) para justificar una calificación, eliminando el "yo creo que...".

### Panorama de Herramientas AI en el Mercado
